#ifndef VHDNestedParamCellFlux_h
#define VHDNestedParamCellFlux_h 1
...
class VHDNestedParamCellFlux: public G4VPrimitiveScorer
{
   public:
	VHDNestedParamCellFlux(G4String name,G4int nx, G4int ny, G4int nz,G4int depth=0);
	VHDNestedParamCellFlux(G4String name, const G4String& unit,G4int depth=0);
	virtual ~VHDNestedParamCellFlux();
